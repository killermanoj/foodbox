...
import static sample.foody.MenuController.i;
   ...
   // public static int ze;
     ...
     public void calculate(){
        try {
            ...
            while(rs.next()){
                ...
                amounttxt.setText(Integer.toString(MenuController.total));
            }
    ...
    @FXML
     public void ConfirmedScreen(ActionEvent event) throws Exception  {
		...
		Parent root =FXMLLoader.load(getClass().getResource("../view/Confirmed.fxml"));
             ...
             if(paymentModel.isPaymentOnline()&&paymentModel.isCard()){
                 if(!(cardnumtxt.getText().isEmpty()||cardholdertxt.getText().isEmpty()||cvvtxt.getText().isEmpty()||monthtxt.getText().isEmpty()||yeartxt.getText().isEmpty())){
                     ...
                     try {
                         ...
                         dialogStage.close();
                         Scene scene;
                         scene = new Scene(FXMLLoader.load(getClass().getResource("../view/Confirmed.fxml")));
                 ...
                 infoBox1("Order Confirmed",null, "Success");
                  try {
                         ...
                         scene = new Scene(FXMLLoader.load(getClass().getResource("../view/Confirmed.fxml")));
                         dialogStage.setScene(scene);
                         dialogStage.show();PreparedStatement preparedStatement = null ;
                      ResultSet resultSet =null;
                      String query="select email_id from customer where customer_id=? ";
                      try {
                          preparedStatement = con.prepareStatement(query);
